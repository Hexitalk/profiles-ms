...
import { profilesMongoProviders } from './mongo/providers/profile.mongo.providers';
import { ProfileDbRepository } from './repositories/profile-db.repository';
...
@Module({
  ...
  providers: [
    ...profilesMongoProviders,
    ...Object.values(useCases),
    ProfileDbRepository,
    {
      provide: ProfileRepository,
      useExisting: ProfileDbRepository,
    },
